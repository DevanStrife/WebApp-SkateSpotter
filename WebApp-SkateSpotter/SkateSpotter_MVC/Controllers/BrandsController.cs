...
namespace SkateSpotter_MVC.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Website,NumberOfFavourites")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Website,NumberOfFavourites")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
