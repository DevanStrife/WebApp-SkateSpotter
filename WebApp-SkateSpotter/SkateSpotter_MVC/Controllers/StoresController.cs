...
namespace SkateSpotter_MVC.Controllers
{
    public class StoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Country,State,City,Adress,ZipCode,PhoneNumber,Email,Website,OwnerId")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Country,State,City,Adress,ZipCode,PhoneNumber,Email,Website,OwnerId")] Store store)
        {
            if (id != store.Id)
            {
                return NotFound();
